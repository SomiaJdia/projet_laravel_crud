    ...
    <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-16">
                ...
                <div class="w-full h-full bg-white rounded-[2.8rem] overflow-hidden relative shadow-inner">
                    ...
                    <div class="relative z-10 h-full flex flex-col px-7 py-8">
                        ...
                        <div class="text-center mb-1">
                            <h1 class="text-xl font-bold text-gray-800 mb-1">Login</h1>
                            <p class="text-xs text-gray-400">Access your account with magic link</p>
                        </div>
                        ...
                        <!-- Form -->
                        <form action="/login" method="POST" class="space-y-3 flex-1">
                            @csrf
                            ...
                            <div class="flex items-center justify-between pt-1">
                                <label class="flex items-center">
                                    <input type="checkbox" name="remember" class="w-3.5 h-3.5 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                                    <span class="ml-2 text-xs text-gray-600">Remember me</span>
                                </label>
                                <a href="{{ route('password.request') }}" class="text-xs text-purple-600 hover:text-purple-700 transition font-medium">
                                    Forgot?
                                </a>
                            </div>
                            ...
                            <button 
                                type="submit"
                                class="w-full py-3 text-white font-bold text-sm tracking-wide rounded-xl shadow-lg transition transform hover:scale-[1.02] active:scale-[0.98] mt-4"
                            ...
                            <div class="text-center pt-2">
                                <a href="/register" class="text-xs text-gray-600 hover:text-purple-600 transition font-medium">
            ...
            <div class="text-white">
                <h2 class="text-5xl font-bold leading-tight mb-2">Login with</h2>
