    ...
    <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-16">
                    ...
                    <div class="relative z-10 h-full flex flex-col px-7 py-8">
                        ...
                        <div class="flex justify-center mb-3">
                            <div class="w-20 h-20 bg-gray-50 rounded-3xl flex items-center justify-center shadow-sm border border-gray-100">
                                <i class="fas fa-user-edit text-gray-300 text-3xl"></i>
                            </div>
                        </div>

                        <!-- Title -->
                        <div class="text-center mb-1">
                            <h1 class="text-xl font-bold text-gray-800 mb-1">Modifier Étudiant</h1>
                            <p class="text-xs text-gray-400">Mettez à jour les informations</p>
                        </div>
                        ...
                        <!-- Form -->
                        <form action="/Modifier/trait/{{$etudiant->id}}" method="POST" class="space-y-2.5 flex-1">
                            @csrf
                            @method('PUT')
            ...
            <div class="text-white">
                <h2 class="text-5xl font-bold leading-tight mb-2">Modifier un</h2>
